...
<div class="pagina">
        ...
        <div class="container right">
            <H1>INICIA SESIÓN</H1>
            <input class="campos" type="text" placeholder="Teléfono, usuario o correo electrónico">
            <input class="campos" type="password" placeholder="Contraseña">
            <div class="contenedorRecordarContra">
